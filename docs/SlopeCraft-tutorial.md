...
=== "导入 Litematica 投影"
	...
	1. 投影文件的目录为.minecraft[^mcdir]/schematic
...
=== "导入结构方块文件"
	...
	1. 结构方块的目录为.minecraft[^mcdir]/saves/<游戏存档名>/generated/minecraft/structures
...
=== "导入 WE 原理图"
	...
	1. World Edit原理图的目录为.minecraft[^mcdir]/config/worldedit/schematics
...
=== "导入地图文件"
    ...
    1. 地图文件的目录为.minecraft[^mcdir]/saves/<游戏存档名>/data
